			...
			public IEnumerable<IProduct> Items
			{
				get
				{
					if (_items == null)
					{
						...
						_items.AddRange(_lootGenerator.GetRandomComponents(_level - 25, random.Next(2, 6) + extraGoods, Faction.Undefined, _random.Seed + _starId, false, false, extraGoods > 0 ? Constructor.ComponentQuality.P1 : ComponentQuality.P0)
