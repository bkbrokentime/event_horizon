		...
		public class FactionInventory : IInventory
		{
			...
			void CreateHomeRegionItems()
			{
			    ...
			    for (var i = 0; i < 5 + extraGoods; ++i)
                    _items.Add(_productFactory.CreateRandomComponentProduct(_starId, i, _level, Constructor.ComponentQuality.P1, _faction, false, false, Market.CommonComponentRenewalTime, false, 2f*pricescale));
