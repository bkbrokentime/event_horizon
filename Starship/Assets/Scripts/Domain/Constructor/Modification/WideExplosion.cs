...
{
    class WideExplosion : IModification
    {
        public WideExplosion(ModificationQuality quality)
        {
            _damageMultiplier = quality.PowerMultiplier(0.5f, 0.6f, 0.7f, 0.8f, 0.9f, 0.8f, 0.7f, 0.6f, 0.4f, 0.2f);
            _areaOfEffectMultiplier = quality.PowerMultiplier(0.5f, 0.6f, 0.7f, 0.8f, 0.9f, 1.5f, 2.0f, 2.5f, 3.0f, 4.0f); 
            Quality = quality;
        }
