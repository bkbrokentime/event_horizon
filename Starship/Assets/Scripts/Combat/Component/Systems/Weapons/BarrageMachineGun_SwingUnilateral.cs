...
{
    public class BarrageMachineGun_SwingUnilateral : SystemBase, IWeapon
    {
        public BarrageMachineGun_SwingUnilateral(IWeaponPlatform platform, WeaponStats weaponStats, Factory.IBulletFactory bulletFactory, int keyBinding, IShip ship)
