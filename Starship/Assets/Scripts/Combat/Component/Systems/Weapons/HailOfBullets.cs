...
{
    public class HailOfBullets : SystemBase, IWeapon
    {
        public HailOfBullets(IWeaponPlatform platform, WeaponStats weaponStats, Factory.IBulletFactory bulletFactory, int keyBinding, IShip ship)
