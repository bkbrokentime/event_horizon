...
{
    public class BarrageMultishot_SwingUnilateral : SystemBase, IWeapon
    {
        public BarrageMultishot_SwingUnilateral(IWeaponPlatform platform, WeaponStats weaponStats, Factory.IBulletFactory bulletFactory, int keyBinding, IShip ship)
