...
{
    public class BarrageCannon_Swing : SystemBase, IWeapon
    {
        public BarrageCannon_Swing(IWeaponPlatform platform, WeaponStats weaponStats, Factory.IBulletFactory bulletFactory, int keyBinding, IShip ship)
