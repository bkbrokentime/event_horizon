...
{
    public class EnergyDiversionDevice : SystemBase, IDevice, IFeaturesModification, IStatsModification
    {
        public EnergyDiversionDevice(IShip ship, DeviceStats deviceSpec, int keyBinding)
